package classwork43.stream_primitives;
...
public class PrimitiveStreamExample {
    ...
    public static void main(String[] args) {
        ...
        // numbers.forEach(System.out::println); // распечатывает в столбик
        // numbers.forEach(n -> System.out.print(n + " ")); // распечатывает в ряд
        ...
        System.out.println("-------------- моделирование 6 из 49 -----------------");

        Stream<Integer> lotteryNumbers = getRandomNumbers(1, 50, 6)
                .distinct() // убирает повторы, но при этом уменьшается количество чисел, значит нужно залимитить
                .limit(6);
