...
public class GarageImpl implements Garage {
    ...
    // Добавленные методы сортировки для интерфейса Garage

    @Override
    public Car[] sortByBrand() {
        Car[] sortedCars = Arrays.copyOf(cars, size);
        Arrays.sort(sortedCars, Comparator.comparing(Car::getModel));  // сортировка по модели
        return sortedCars;
    }
    ...
    public Car[] sortByColor() {
        Car[] sortedCars = Arrays.copyOf(cars, size);
        Arrays.sort(sortedCars, Comparator.comparing(Car::getColor));  // сортировка по цвету
        return sortedCars;
    }
    ...
    public Car[] sortByCompany() {
        Car[] sortedCars = Arrays.copyOf(cars, size);
        Arrays.sort(sortedCars, Comparator.comparing(Car::getCompany));  // сортировка по компании
        return sortedCars;
    }
}
